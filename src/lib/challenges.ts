...
export const challenges: Challenge[] = [
  ...
  },
  {
    ...
    icon: 'Layers',
    color: 'bg-amber-600',
    puzzle: 'SmVyb2VuMjAyNiE=',
    puzzleNote: 'Het = teken aan het einde is misschien een aanwijzing...',
    hints: [
      'Dit is een veelgebruikt coderingssysteem op het internet om data te transporteren.',
      'Het systeem heet Base-en-dan-een-getal. Vraag Claude welke opties er zijn.',
    ],
  },
  {
    slug: 'suzet',
